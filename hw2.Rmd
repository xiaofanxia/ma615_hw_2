...
Computer Age Statistical Inference: Algorithms, Evidence, and Data Science Cambridge University Press, 2016 https://web.stanford.edu/~hastie/CASI_files/PDF/casi.pdf

Modern Bayesian practice uses various strategies to construct an appropriate “prior” g($\mu$)n the absence of prior experience, leaving many statisticians unconvinced by the resulting Bayesian inferences. Our second example illustrates the difficulty.
